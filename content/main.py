...
_JSONLD = f"""<meta name="naver-site-verification" content="f6703b4e7975aa4aa47300925d4a43b736d8a2f8">
...
PAGE = {
    ...
    "desc": "송파 출장마사지·홈타이 안내 페이지입니다. 잠실동, 문정동, 가락동, 방이동, 석촌동과 송파구 주요 지하철역 인근, 테마별 관리, 예약 전 확인사항을 확인해보세요.",
